...
namespace FantasyEngine.Classes
{
    public class Title : Scene
    {
        ...
        private void NewGame()
        {
            ...
            Player.GamePlayer.Hero = new Sprite(Game, @"Characters\characters", Player.GamePlayer.Actors[0].CurrentJob.BaseJob.OverworldSpriteSize, startingPoint, Sprite.OVERWORLD_SIZE);
