		...
		private void DrawCompare(GameTime gameTime, BaseItem item)
		{
			...
			if (item != null && !(item is Item))
			{
				...
				if (item.IsAllowed(actor.CurrentJob.BaseJob))
				{
					...
					spriteBatchGUI.DrawString(GameMain.font, actor.getBaseDamage(ePhysicalDamageOption.BOTH).ToString().PadLeft(3, ''),
					...
					spriteBatchGUI.DrawString(GameMain.font, (actor.getHitPourc(ePhysicalDamageOption.BOTH) + "%").PadLeft(3, ''),
					...
					spriteBatchGUI.DrawString(GameMain.font, (actor.getMagicAttackMultiplier(eMagicalDamageOption.NONE) + "x").PadLeft(3, ''),
						new Vector2(534, 362) + spriteBatchGUI.CameraOffset, Color.White);
					spriteBatchGUI.DrawString(GameMain.font, actor.getMagicBaseDamage(eMagicalDamageOption.NONE, 1).ToString().PadLeft(3, ''),
					...
					spriteBatchGUI.DrawString(GameMain.font, (actor.getMagicHitPourc(eMagicalDamageOption.NONE, 80) + "%").PadLeft(3, ''),
